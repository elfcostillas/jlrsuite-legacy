						...
						<div class="col-md-12">	
							<div class="checkbox">
								<label><input type="checkbox" name='has_preferred' value="1">
									<textarea name="preferred_content" id="preferred_content" cols="150" rows="1" class="form-control" disabled="disabled">JLR Construction and Aggregates. Inc is the first preferred concrete supplier.</textarea>
								</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" name='has_content' value="1">
									<textarea name="add_condition" id="add_condition" cols="150" rows="2" class="form-control">client will supply Bul Portland Cement to JLR Batching Plant and to maintain an inventory of <b>5,000 bags higher</b> at any given time.</textarea>
								</label>
							</div>
						</div>
					</div>	
