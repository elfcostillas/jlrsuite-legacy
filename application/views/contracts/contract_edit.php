					...
					<div class="row">
						...
						<div class="col-md-12">	
							...
							<div class="checkbox">
								...
								<?php if ($has_preferred == 1) echo "Checked";?>>
							...
							<div class="checkbox">
								<label><input type="checkbox" name='has_content' value="1" <?php if($content != '')echo 'Checked'; ?>>
									<textarea name="add_condition" id="add_condition" cols="150" rows="2" class="form-control"><?=$content;?></textarea>
								</label>
							</div>
						</div>
						</div>
