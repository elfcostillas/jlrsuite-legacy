				  ...
				  <div class="container">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav">
				        <li><a href='<?php echo site_url("leavesv2"); ?>'>Home</a></li>
				        <li><a href='<?php echo site_url("leavesv2/leave_application"); ?>'>Leave Applications</a></li>
				        <li><a href='<?php echo site_url("leavesv2/leave_status"); ?>'>Leaves Status</a></li>
				        <li class="dropdown">
				      ...
				      <ul class="nav navbar-nav navbar-right">
				      	<!-- <li><a href="#" id="leave-notif" class="glyphicon glyphicon-user" aria-hidden="true">
				      		<id id="noty-counter">0</id>
				      	</a></li> -->
